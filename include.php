<?php
    ...
    //将您使用的拓展置于此处
    include_once ("extension/checkad.php"); //注释以禁用该拓展
    include_once ("extension/ideasdb.php"); //注释以禁用该拓展
    include_once ("extension/import.php"); //注释以禁用该拓展
    include_once ("extension/pediawiki.php"); //注释以禁用该拓展
    include_once ("extension/testfunc1.php"); //注释以禁用该拓展
    include_once ("extension/zhwpfunc1.php"); //注释以禁用该拓展
    include_once ("extension/zhmgfunc1.php"); //注释以禁用该拓展
